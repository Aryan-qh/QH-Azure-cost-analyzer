...
from app.api.routes.agent import router_agent  # NEW IMPORT
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Azure Cost Analyzer - Monitor and analyze Azure costs with AI-powered conversational agent"
    )
    ...
    async def root(settings: Settings = Depends(get_settings)):
        ...
        return {
            "message": "Azure Cost Analyzer API with AI Agent",
            "version": settings.api_version,
            "docs": "/docs",
            "endpoints": {
                "health": "/api/health",
